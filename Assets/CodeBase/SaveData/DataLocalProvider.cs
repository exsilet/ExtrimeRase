...
namespace SaveData
{
    public class DataLocalProvider : IDataProvider
    {
        ...
        public bool TryLoad()
        {
            ...
            _persistentData.DataBase = JsonConvert.DeserializeObject<DataBase>(File.ReadAllText(FullPath));
            return true;
        }

        public void Save()
        {
            File.WriteAllText(FullPath, JsonConvert.SerializeObject(_persistentData.DataBase, Formatting.Indented, new JsonSerializerSettings
            {
